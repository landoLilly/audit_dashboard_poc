defmodule AuditDashboardPoc.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: AuditDashboardPoc.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    AuditDashboardPocWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
