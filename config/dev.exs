...
config :audit_dashboard_poc, AuditDashboardPoc.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "audit_dashboard_poc_dev",
  stacktrace: true,
...
config :audit_dashboard_poc, AuditDashboardPocWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "tPqracWpM6WQGsnzGwEjCh9b5fZgTIo9h2ayu0A9s016k9PkCoE4/vqwQSZOHTE5",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:audit_dashboard_poc, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:audit_dashboard_poc, ~w(--watch)]}
  ]
...
config :audit_dashboard_poc, AuditDashboardPocWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/audit_dashboard_poc_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :audit_dashboard_poc, dev_routes: true
